...
it('lets 2 users exchange stars', async() => {
    ...
    let starId1 = 7
    let starId2 = 8
    await instance.createStar('test star x', starId1, {from: user1});
    await instance.createStar('test star y', starId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    let user2 = accounts[2];
    let starId = 9
    await instance.createStar('test star z', starId, {from: user1});
